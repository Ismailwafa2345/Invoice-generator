...
.wrap-lang .stButton > button {
    background:#1a1a2e !important;color:#a78bfa !important;
    border:2px solid #6c63ff !important;
    font-size:13px !important;white-space:nowrap !important;
}
.wrap-lang .stButton > button:hover {background:#6c63ff !important;color:#fff !important}
...
with left_col:
    ...
    for col, lbl in zip([hh1, hh2, hh3], ["desc_col", "qty_col", "rate_col"]):
        col.markdown(
            ...
            f"text-transform:uppercase;padding-bottom:4px'>{L(lbl)}</div>",
            unsafe_allow_html=True
        )
